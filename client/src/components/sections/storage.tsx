    ...
    <section ref={ref} className="min-h-screen flex items-center bg-black">
      <div className="container mx-auto px-4">
        ...
        >
          {isInView && (
            <TypeAnimation
              sequence={["Stage 1: Secure & Verified Storage", 1000]}
              wrapper="h2"
  ...
  <CardContent className="p-6 flex items-start gap-4">
    ...
    <div>
      ...
      <p className="text-base text-gray-400">
        Send sneakers to any of our secure locations, ensuring safe handling and seamless onboarding.
      </p>
    </div>
  </CardContent>
           </Card>
              ...
              <Card className="bg-pink-900/20 border-pink-500/20">
                <CardContent className="p-6 flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-base text-gray-400">
                      Each sneaker is authenticated by industry experts and placed in climate-controlled vaults for safekeeping.
                    </p>
                  </div>
                </CardContent>
              </Card>
